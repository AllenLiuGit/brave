...
public final class Tracer implements Span.Factory {
  ...
  public static final class Builder {
    ...
    public Builder ticker(Ticker ticker) {
      if (ticker == null) throw new NullPointerException("ticker == null");
      this.ticker = ticker;
      return this;
    }
    ...
    public Tracer build() {
      SpanRecorder spanRecorder = new SpanRecorder(
          ...
          ticker != null ? ticker : Platform.get(),
          clock != null ? clock : Platform.get()
      );
      return new Tracer(spanRecorder, sampler, traceId128Bit);
    }
  }
  ...
  Tracer(SpanRecorder spanRecorder, Sampler sampler, boolean traceId128Bit) {
  ...
  Span toSpan(TraceContext context) {
    ...
    if (context.sampled()) {
      return new RealSpan(context, spanRecorder);
    }
